...
function whatsapp() {
  ...
  let text2 = `Portugal ${plac[86]} X ${plac[87]} Gana %0ACoreia do Sul ${plac[88]} X ${plac[89]} Gana %0APortugal ${plac[90]} X ${plac[91]} Uruguai %0ACoreia do Sul ${plac[92]} X ${plac[93]} Portugal %0AGana ${plac[94]} X ${plac[95]} Uruguai %0A%0A*1º Campeão:* ${campeao1} %0A*2º Campeão:* ${campeao2} %0A%0A*1º Artilheiro:* ${jogadorArt1}%0A*2º Artilheiro:* ${jogadorArt2}%0A%0A%0APix R$ 10,00: 19992481225`
